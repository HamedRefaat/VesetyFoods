					...
					<div class="login-form">
						<form id="login-form" method="post" action="<?php echo get_permalink( get_page_by_title( 'menus' ) )?>">
							...
							<div class="form-content">
                              ...
                              if($_GET['logstatus']=='pr')
                              {
                                    echo '<h1>Greate, Password Changed Successfully. Please, LogIn With New Password </h1>';
                              }
}
								...
								<div class="forget-pas">
									<h3> <a href="<?php echo get_permalink( get_page_by_title( 'lostpassword' ) )?>">Lost your Password?</a> </h3>
								</div>
							</div>
						</form>
					</div>
